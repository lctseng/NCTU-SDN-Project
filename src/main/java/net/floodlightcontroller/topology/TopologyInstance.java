...
public class TopologyInstance {
    ...
    public void compute(int priority) {
        ...
        calculateShortestPathTreeInClusters(priority);
    ...
    protected void calculateShortestPathTreeInClusters() {
        this.calculateShortestPathTreeInClusters(0);
    }
    
    // TODO:SDN:Functopn: Add traffic
    public void setTrafficMap(Map<Link,Map<Integer,Integer> > t){
        traffic = t;
    ...
    protected void calculateShortestPathTreeInClusters(int priority) {
        pathcache.invalidateAll();
        destinationRootedTrees.clear();

        Map<Link, Integer> linkCost = new HashMap<Link, Integer>();
        // FIXME:SDN  No Tunnels 
